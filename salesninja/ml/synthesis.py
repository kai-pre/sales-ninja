...
class SalesNinjaSynthesis():
    def __init__(self, dataframe):
        ...
        self.constraints = [
            FixedCombinations(
                column_names=['CityName', 'ContinentName', 'StateProvinceName',
                              ...
                              'RegionCountryName_Australia', 'RegionCountryName_Bhutan',
                                ...
                                'RegionCountryName_the Netherlands',]
            ),
            FixedCombinations(
            ...
            OneHotEncoding(
                column_names=['BrandName_A. Datum', 'BrandName_Adventure Works', 'BrandName_Contoso',
                                ...
                                'RegionCountryName_Thailand', 'RegionCountryName_Turkmenistan',
                                'RegionCountryName_United Kingdom', 'RegionCountryName_United States',
                                'RegionCountryName_the Netherlands', 'StoreType_Catalog', 'StoreType_Online',
    ...
    def sample(self, startdate, enddate):
        """
