...
#GCP_SALESNINJA = "<<<Salesninja Project ID on GoogleCloud>>>"
GCP_REGION = "europe-west1"
#BQ_DATASET = "<<<Salesninja BigQuery Dataset name>>>" # "salesninja"?
BQ_REGION = "EU"
#BUCKET_NAME = "<<<Salesninja BucketName on GoogleCloud>>>"
